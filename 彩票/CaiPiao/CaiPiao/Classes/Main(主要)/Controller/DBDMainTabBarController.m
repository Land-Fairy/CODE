...
- (void)setUpChildVC{
    /**
      * 购彩大厅
      */
    DBDHallViewController *hallVC = [[DBDHallViewController alloc] init];
    [self setupChildController:hallVC image:[UIImage imageNamed:@"TabBar_Hall_new"] seleImage:[UIImage imageNamed:@"TabBar_Hall_selected_new"]title:@"大厅"];
...
//    [self setupChildController:discoverVC image:[UIImage imageNamed:@"TabBar_Discovery_new"] seleImage:[UIImage imageNamed:@"TabBar_Discovery_selected_new"] title:@"发现"];
     ...
     * 开奖信息
     */
    Lottery *historyVC = [[Lottery alloc] init];
